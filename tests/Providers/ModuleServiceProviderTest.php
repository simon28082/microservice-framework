...
use CrCms\Microservice\Foundation\ModuleServiceProvider;
...
/**
 * Class ModuleServiceProviderTest
...
//        $this->assertEquals('testing',$app->make('translator')->trans('support::lang.test'));
//        dd(app('translator')->trans('support::lang.test'));
//        dd(trans('support::lang.test'));
    }
